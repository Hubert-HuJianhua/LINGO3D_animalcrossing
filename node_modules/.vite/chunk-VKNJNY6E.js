...
// node_modules/@lincode/utils/lib/index.js
var import_lodash = __toESM(require_lodash());
var forceGet = (map, obj, factory) => {
  if (!map.has(obj)) {
    const item = factory();
    map.set(obj, item);
    return item;
...
var traverse = (obj, cb, traversed = /* @__PURE__ */ new WeakSet()) => {
...
var throttle = (fn, timeout, edge) => {
  let result;
  let blocked = false;
  let args0;
  let resultResolve = void 0;
  let resultPromise = edge === "trailingPromise" ? new Promise((r) => resultResolve = r) : void 0;
  return function(...args) {
    ...
    const cb = () => {
      if (edge === "trailing" || edge === "both" || edge === "trailingPromise") {
        ...
        resultPromise = edge === "trailingPromise" ? new Promise((r) => resultResolve = r) : void 0;
      }
      blocked = false;
    };
...
var cancellableTimeout = (cb, time) => {
  if (time === 0) {
    let signal = true;
...
var type = (val) => val;
var lazy = (factory, invalidateWhenReturnValueChanges) => {
  let result;
  let has2 = false;
...
var applyMixins = (toClass, fromClasses) => {
  for (const fromClass of fromClasses)
    for (const name of Object.getOwnPropertyNames(fromClass.prototype))
      Object.defineProperty(toClass.prototype, name, Object.getOwnPropertyDescriptor(fromClass.prototype, name) || /* @__PURE__ */ Object.create(null));
};
var preventTreeShake = (obj) => obj;

// node_modules/@lincode/promiselikes/lib/index.js
var Thenable = class {
  constructor(_cb = void 0) {
    this._cb = _cb;
    this.done = void 0;
    this._value = void 0;
    this._callbacks = void 0;
    this._watched = void 0;
  }
  then(cb) {
    var _a;
    if (this.done) {
    ...
    ;
    ((_a = this._callbacks) !== null && _a !== void 0 ? _a : this._callbacks = /* @__PURE__ */ new Set()).add(cb);
  ...
  watch(item) {
    ...
    ((_a = this._watched) !== null && _a !== void 0 ? _a : this._watched = /* @__PURE__ */ new Set()).add(item);
...
var Resolvable = class extends Thenable {
  constructor(cb) {
    super(cb);
  }
  resolve(val) {
...
var Cancellable = class extends Thenable {
  constructor(cb) {
    super(cb);
  }
  cancel(val) {
...
var Disposable = class extends Thenable {
  constructor(cb) {
    super(cb);
  }
  dispose(val) {
...
var cancelled = new Cancellable().cancel();

// node_modules/@lincode/events/lib/Events.js
var Events_default = class {
  constructor() {
  ...
  on(name, cb) {
    ...
    const cbs = forceGet(this.cbsMap, name, () => /* @__PURE__ */ new Set());
    cbs.add(cb);
  ...
  setState(name, value) {
    var _a;
    (_a = this.states) !== null && _a !== void 0 ? _a : this.states = /* @__PURE__ */ new Map();
...
// node_modules/@lincode/events/lib/event.js
var Event = class {
  constructor() {
...
// node_modules/@lincode/reactivity/lib/store.js
var globalStateGetters = /* @__PURE__ */ new WeakSet();
var isGlobalState = (getter) => globalStateGetters.has(getter);
var store = (data) => {
  const [, onData, setData, getData] = event_default();
  setData(data);
...
// node_modules/@lincode/reactivity/lib/helpers.js
var push = (setState, getState) => (val) => {
  const array = getState();
  array && setState([...array, val]);
};
var pull2 = (setState, getState) => (val) => {
  const array = getState();
  array && setState(array.filter((item) => item !== val));
};
var reset = (setState, getState) => {
...
// node_modules/@lincode/reactivity/lib/fiber.js
var fiberStack = [];
var fiberCache = (value) => {
  var _a;
  var _b, _c;
  const store2 = fiberStack[fiberStack.length - 1];
  return (_a = (_b = store2.fiber)[_c = store2.count++]) !== null && _a !== void 0 ? _a : _b[_c] = value();
};
var fiberStore = (value) => {
  var _a;
  var _b;
  const store2 = fiberStack[fiberStack.length - 1];
  const index = store2.count++;
  (_a = (_b = store2.fiber)[index]) !== null && _a !== void 0 ? _a : _b[index] = value;
  return [
    () => store2.fiber[index],
    (val) => store2.fiber[index] = val
  ];
};
var diffAndRun = (cleanup, fiber, getStates, statesOld, cb) => {
  ...
  const result = shouldRun ? cb() : void 0;
  fiberStack.pop();
  return [result, states, shouldRun];
};
var createEffect = (cb, getStates) => {
  if (fiberStack.length) {
    ...
    const [getCleanUp, setCleanUp] = fiberStore(void 0);
    const [getStatesOld, setStatesOld] = fiberStore(void 0);
    ...
    shouldRun && setCleanUp(typeof result === "function" ? result : void 0);
    setStatesOld(states);
    return handle;
  } else {
    ...
    const cbDebounced = debounce(() => {
      const [result, states, shouldRun] = diffAndRun(cleanup, fiber, getStates, statesOld, cb);
      shouldRun && (cleanup = typeof result === "function" ? result : void 0);
      statesOld = states;
    }, 0, "trailing");
    cbDebounced();
...
var createRef = (value) => {
  ...
  var _b, _c;
  const store2 = fiberStack[fiberStack.length - 1];
  return (_a = (_b = store2.fiber)[_c = store2.count++]) !== null && _a !== void 0 ? _a : _b[_c] = { current: typeof value === "function" ? value() : value };
};

// node_modules/@lincode/reactivity/lib/Reactive.js
var Reactive = class {
  constructor(value) {
    [this.set, this.get] = store(value);
  }
};
Reactive.createEffect = createEffect;

// node_modules/lingo3d/lib/states/useLoadingCount.js
var [setLoadingCount, getLoadingCount] = store(0);
var increaseLoadingCount = () => setLoadingCount(getLoadingCount() + 1);
var decreaseLoadingCount = () => setLoadingCount(getLoadingCount() - 1);
 ...
 */
//# sourceMappingURL=chunk-VKNJNY6E.js.map
